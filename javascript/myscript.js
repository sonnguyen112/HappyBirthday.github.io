...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Cắt bánh sinh nhật " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Lời chúc danh cho Duy:';
document.querySelector('.Description .modal-body').innerHTML = 'SINH NHẬT VUI VẺ NHA NÂU!!! <i class="fas fa-heart"></i> ';
